# Drop Script — rsl_lp_db_array_ops

This script safely drops the MongoDB database used by this module (`rsl_lp_db_array_ops`).
Run it after finishing the exercises or when you need a clean reset.
...
What it does:
- Selects the `rsl_lp_db_array_ops` database.
